...
def SEMI_CIRCULAR_OUTER(hd,RADIUS,WIDTH,LX,DX,lc,ELEM,ELEM_ARCS,path):
    ...
    gmsh.model.add("modelo_semi_circular_outer")
    ...
    # POROUS_BOUNDARY {}
    gmsh.model.addPhysicalGroup(2, s[15:18], 3)
    ...
    # SAVE THE MESH
    filename = 'SEMI_CIRCULAR_OUTER.msh'
    #filename = 'SEMI_CIRCULAR_OUTER.m'
    gmsh.write(filename)
