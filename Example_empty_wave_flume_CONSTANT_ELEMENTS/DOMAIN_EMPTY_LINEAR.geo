...
LENGTH    = 1.00 * hd;      // Length in X
WIDTH     = 0.10 * hd;     // Width in Y
...
//Transfinite Line {5:8} = 3*ELEM + 1 Using Progression 1;

// Y-direction resolution
//Transfinite Line {1:4} = 5 Using Progression 1;

// Z-direction resolution
//Transfinite Line {9:12} = ELEM_Z Using Progression 1;
