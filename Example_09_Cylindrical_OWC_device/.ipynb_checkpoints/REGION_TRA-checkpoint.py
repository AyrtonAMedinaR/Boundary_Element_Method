...
def REGION_TRA(lc,ELEM_TOP,ELEM_X,hd,FLUME_WIDTH,RADIO,RADIO_THICK,LENGTH_X,DX,path):
    ...
    SHIFT_X = LENGTH_X + 2*RADIO_THICK + 2*DX

    ###############################
    # POINTS, TOP

    #  EXTERIOR SQUARE
    p19_1 = geom.addPoint(SHIFT_X,             + SQ_BOUND,       0,lc)
    p20_1 = geom.addPoint(SHIFT_X,             - SQ_BOUND,       0,lc)
    p21_1 = geom.addPoint(SHIFT_X + LENGTH_X,  - SQ_BOUND,       0,lc)
    p22_1 = geom.addPoint(SHIFT_X + LENGTH_X,  + SQ_BOUND,       0,lc)

    p20_2 = geom.addPoint(SHIFT_X,             FLUME_WIDTH/2,       0,lc)
    p21_2 = geom.addPoint(SHIFT_X + LENGTH_X,  FLUME_WIDTH/2,       0,lc)

    p19_4 = geom.addPoint(SHIFT_X,            -FLUME_WIDTH/2,       0,lc)
    p22_4 = geom.addPoint(SHIFT_X + LENGTH_X, -FLUME_WIDTH/2,       0,lc)

    ###############################
    # POINTS, BOTTOM

    #  EXTERIOR SQUARE
    pb9_1  = geom.addPoint(SHIFT_X,             + SQ_BOUND,       -hd,lc)
    pb10_1 = geom.addPoint(SHIFT_X,             - SQ_BOUND,       -hd,lc)
    pb11_1 = geom.addPoint(SHIFT_X + LENGTH_X,  - SQ_BOUND,       -hd,lc)
    pb12_1 = geom.addPoint(SHIFT_X + LENGTH_X,  + SQ_BOUND,       -hd,lc)

    pb10_2 = geom.addPoint(SHIFT_X,             FLUME_WIDTH/2,       -hd,lc)
    pb11_2 = geom.addPoint(SHIFT_X + LENGTH_X,  FLUME_WIDTH/2,       -hd,lc)

    pb9_4  = geom.addPoint(SHIFT_X,            -FLUME_WIDTH/2,       -hd,lc)
    pb12_4 = geom.addPoint(SHIFT_X + LENGTH_X, -FLUME_WIDTH/2,       -hd,lc)   
