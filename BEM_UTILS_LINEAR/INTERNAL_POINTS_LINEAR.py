...
from MATRICES_LINEAR.ETAXJA5 import ETAXJA5
from MATRICES_LINEAR.EXTIN5 import EXTIN5

def INTERNAL_POINTS_LINEAR(FI, DFI, hd, CX, CY, CZ, POS, NCONEC, KCONEC, N, NE, Region):
    ...
    for IE in range(NE_act):
        ...
        # Call ETAXJA
        ETA1, ETA2, ETA3, XJA, XG1, XG2, XG3, FF = ETAXJA5(
            XJ1, XJ2, XJ3, NCONEC
        )
